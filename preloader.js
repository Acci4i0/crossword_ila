...
// Vanilla + Web Animations API, nessuna dipendenza. Si avvia da solo a ogni
// load (qui sostituisce lo spinner: l'originale mostrava un loader anche al
// reload post-completamento).
(function showPreloader() {
  ...
  setTimeout(() => {
    // lo sfondo sparisce quando parte il volo: la griglia si rivela sotto il
    // numero in movimento, come in 2Dgallery
